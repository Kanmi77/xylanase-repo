#!/usr/bin/env python3
"""
Export grouped enzyme-family datasets from a curated master table.

For the xylanase thesis, this exports GH10/GH11 bacterial, fungal and archaeal
subsets from the frozen thesis dataset. The script is generic and can be reused
for other enzyme projects by changing the accepted families and organism groups.

Outputs per group/family:
    - CSV table
    - FASTA file
    - TXT FASTA-compatible file
    - summary CSV
    - metadata JSON
"""
