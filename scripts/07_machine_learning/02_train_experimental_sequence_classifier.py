#!/usr/bin/env python3
"""
Train non-circular experimental-label sequence classifiers using Tmxyl and Toptxyl.

Targets:
- Tm experimental class: thermophilic vs mesophilic/lower using 60C threshold
- Topt experimental class: thermophilic vs mesophilic/lower using 60C threshold

Features:
- sequence length
- amino acid composition
- simple physicochemical group fractions

No FoldX, docking, MD, or structure-derived labels are used.
"""
