#!/usr/bin/env python3
"""
Prepare external experimental xylanase thermostability labels from Tmxyl/Toptxyl.

Inputs:
- data/external/TmxylAndToptxyl/extracted/Tm/data_Tm.xlsx
- data/external/TmxylAndToptxyl/extracted/Topt/data_Topt.xlsx

Outputs:
- results/experimental_ml_correction/tmxyl_clean_experimental_labels.csv
- results/experimental_ml_correction/toptxyl_clean_experimental_labels.csv
- results/experimental_ml_correction/tmxyl_toptxyl_combined_experimental_labels.csv
- results/experimental_ml_correction/tmxyl_toptxyl_sequence_deduplicated.csv
- results/experimental_ml_correction/TMXYL_TOPTXYL_PREPARATION_REPORT.md
"""
