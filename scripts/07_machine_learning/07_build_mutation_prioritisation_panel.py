#!/usr/bin/env python3
"""
Build the mutation prioritisation panel for the stability ML goal.

This panel supports the thesis goal:

    identify mutations predicted to improve thermal stability while retaining
    or improving substrate-binding compatibility as an activity-related proxy.

Important:
    This is not supervised mutation ML unless experimental mutation-effect
    labels are available. It is a computational predictor-assisted ranking.

Evidence used:
    - FoldX mutation ΔΔG
    - docking mutant-minus-WT affinity change
    - integrated ranking scores
    - MD validation metrics where available
"""
...
def build_foldx_base():
    """Build one candidate-level FoldX base table."""
...
def build_docking_summary():
    """Build candidate-level docking summary."""
