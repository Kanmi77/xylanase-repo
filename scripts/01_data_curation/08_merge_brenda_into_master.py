#!/usr/bin/env python3
"""
Merge BRENDA metadata into a curated enzyme master table.

This script is generic. It takes a curated master table and a BRENDA-enriched
source table, then transfers all BRENDA columns into the master using stable
identifier matching.

Main merge key:
    uniprot_accession

Fallback keys, when available:
    primary_id
    refseq_acc

Outputs:
    - BRENDA-enriched master CSV
    - metadata JSON with BRENDA coverage counts
"""
