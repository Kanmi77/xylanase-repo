#!/usr/bin/env python3
"""
Download PDB/mmCIF structure files from a normalized PDB inventory.

Input:
    CSV with at least:
        uniprot_accession, pdb_id

Recommended input for frozen thesis:
    data/curated/pdb_inventory_frozen_thesis.csv

Outputs:
    - downloaded structure files
