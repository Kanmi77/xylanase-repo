#!/usr/bin/env python3
"""
Build a frozen-thesis combined structure manifest.

This script filters an existing combined/standardized structure manifest against
a curated master dataset and creates:

1. structure-level manifest
2. protein-level structure availability table
3. unresolved/no-structure protein table

It is designed to work with PDB, MODELLER, AlphaFold, SwissModel, or any other
structure source if the source manifest contains stable identifiers and paths.
"""
