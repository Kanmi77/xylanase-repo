#!/usr/bin/env python3
"""
Create Vina-compatible receptor PDBQT files from cleaned FoldX mutant PDBs.

This fixes the earlier fallback PDBQT issue where:
- protein alpha carbon atom name CA was wrongly interpreted as calcium atom type Ca
- receptor PDBQT contained ligand-style ROOT/ENDROOT/TORSDOF records

This script writes receptor PDBQT files as rigid receptor ATOM-only files.
