#!/usr/bin/env python3
"""
Fetch RefSeq protein FASTA records using NCBI E-utilities.

Input:
    RefSeq inventory CSV with at least:
        refseq_acc, uniprot_accession, organism_type, organism, gh_family
